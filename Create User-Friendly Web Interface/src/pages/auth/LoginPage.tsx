    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 w-full max-w-sm">
        ...
        <div className="mt-6 p-3 bg-gray-50 rounded-xl border border-gray-200">
          <p className="text-xs font-medium text-gray-600 mb-1">Credenciais de teste:</p>
          <p className="text-xs text-gray-500">Coordenador: coordenador / coord123</p>
          <p className="text-xs text-gray-500">Almoxarife: almoxarife / almox123</p>
          <p className="text-xs text-gray-500">Técnico: tecnico / tecnico123</p>
        </div>
      </div>
    </div>
  );
